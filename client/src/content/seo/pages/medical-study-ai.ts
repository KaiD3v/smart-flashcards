...
export const medicalStudyAi: SeoPageContent = {
  ...
  seoTitle: "Medical Study AI for Flashcards | MyRemynd",
  metaDescription:
    "Use medical study AI to turn lecture PDFs into flashcards with human review. MyRemynd pairs AI drafting with FSRS spaced repetition.",
  h1: "Medical Study AI That Strengthens Recall, Not Shortcut Thinking",
  intro:
    "Medical study AI should reduce busywork, not replace the thinking exams demand. The right tool drafts flashcards from your sources, surfaces gaps after question banks, and schedules reviews so facts survive clerkships. MyRemynd combines AI generation with an FSRS engine and a review flow designed for high-stakes retention—so you spend time editing and recalling, not formatting cards at midnight. Used well, medical study AI is the difference between knowing you should review and actually completing today's queue before you sleep.",
  sections: [
    section("what-good-looks-like", "What Good Medical Study AI Actually Does", 2, [
      ...
      "MyRemynd keeps humans in the loop. Generation is the first draft; your edits are the quality gate. That mirrors how attendings expect you to learn—critical appraisal, not passive consumption of summaries.",
    ]),
    ...
    section("vs-chatgpt", "Medical Study AI vs Generic Chat Tools", 2, [
      "Chat interfaces excel at explanation but weak at structured retention unless you manually engineer prompts and scheduling. MyRemynd is purpose-built: ingestion, card objects, FSRS intervals, and review UX in one place. You are not copying JSON between apps or forgetting to review what you generated last Tuesday.",
    ...
    section("safety", "Accuracy, Ethics, and Patient-Safety Mindset", 2, [
      ...
      "MyRemynd does not replace attending teaching or hospital protocols. It helps you memorize and retrieve established facts faster. When a card conflicts with your lecture, your lecture wins until national guidelines say otherwise for boards.",
    ]),
    ...
    section("getting-started", "Getting Started With MyRemynd", 2, [
    ...
    section("team-learning", "AI Assistance in Small Group Learning", 2, [
      ...
      "Keep individual FSRS queues: shared creation does not mean identical schedules. Your misses differ; MyRemynd personalizes intervals per recall history even when card wording started from the same lecture PDF.",
    ]),
    section("privacy-mindset", "Privacy and Data Mindset for AI Study Tools", 2, [
      "Avoid pasting identifiable patient information into any AI tool—use de-identified teaching points only. Lecture PDFs and your own summaries are appropriate inputs. MyRemynd is built for educational content you already have rights to study, not for exporting confidential health records.",
    ...
    section("first-thirty-days", "Your First Thirty Days With Medical Study AI", 2, [
      ...
      "Medical study AI only compounds with daily reviews. MyRemynd shows due counts each morning; treat that number like a lab value you monitor, not a guilt metric you avoid.",
    ]),
  ],
  faqs: [
    {
    ...
    {
      question: "Does MyRemynd replace Anki for med students?",
      answer:
