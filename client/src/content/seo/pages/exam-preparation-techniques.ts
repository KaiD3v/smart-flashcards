...
export const examPreparationTechniques: SeoPageContent = {
  ...
  seoTitle: "Exam Preparation Techniques | SmartFlashcards",
  metaDescription:
    "Learn proven exam preparation techniques: active recall, spaced repetition, and practice tests. SmartFlashcards automates flashcard scheduling.",
  h1: "Exam Preparation Techniques That Actually Stick",
  intro:
    "The best exam preparation techniques share one property: they force your brain to retrieve information before the exam does. Highlighting, passive re-watching lectures, and copying notes feel productive but rarely move scores. A balanced system combines active recall, spaced repetition, realistic practice, and recovery. SmartFlashcards handles the flashcard and scheduling layer so you can execute the techniques consistently without building spreadsheets. Pick three techniques, repeat them for three weeks, and measure practice scores—not vibes—before adding more tools. When techniques are scheduled—not hoped for—you walk into exams with evidence you can retrieve, not just notes you once read.",
  sections: [
    section("active-recall", "Active Recall: The Highest-ROI Technique", 2, [
      ...
      "SmartFlashcards makes daily recall frictionless: a queue of cards scheduled by FSRS, mobile-friendly reviews, and AI-assisted card creation from your notes so you always have material worth retrieving.",
    ]),
    ...
    section("interleaving", "Interleaving and Mixed Practice", 2, [
      "Blocking study (all chapter three, then all chapter four) feels smooth but exams mix topics. Interleave subjects and problem types so you practice choosing strategies, not just executing one template. Tag flashcards by topic in SmartFlashcards, then use mixed review filters before cumulative exams.",
    ...
    section("practice-tests", "Practice Tests and Error Logs", 2, [
      ...
      "SmartFlashcards closes the loop: paste explanation text, generate atomic cards, schedule them into future weeks while you continue new practice tests.",
    ]),
    ...
    section("tooling", "Tooling: When SmartFlashcards Fits the Stack", 2, [
      ...
      "Exam preparation techniques only work when repeated. SmartFlashcards reduces setup friction so the techniques survive busy weeks, not just the first motivated weekend.",
    ]),
    section("environment", "Study Environment and Focus Rituals", 2, [
      "Same place, same start ritual—open SmartFlashcards queue before checking messages—reduces activation energy. Phone on focus mode; browser tabs closed except review. Pomodoro pairs well with flashcard blocks: twenty-five minutes retrieval, five minutes break, then problem sets.",
    ...
    section("focus-deep-work", "Protecting Deep Work During Exam Season", 2, [
      "Block ninety-minute deep-work sessions for practice tests and essay drafting. Silence notifications during SmartFlashcards reviews. Exam preparation techniques need protected attention—fragmented ten-second studying between memes does not count as retrieval practice.",
    ]),
    section("rubrics", "Aligning Techniques With Rubrics and Mark Schemes", 2, [
      "Download rubrics early. Turn each criterion into a retrieval prompt—what defines a top-band essay, what steps earn method marks in physics. SmartFlashcards holds rubric language you must reproduce under pressure; practice tests train application of that language under time limits.",
    ...
    section("self-testing", "Self-Testing Variations Beyond Flashcards", 2, [
      ...
      "SmartFlashcards remains the spine for fact-heavy courses; layer open-ended practice for courses where rubrics demand prose. Combined techniques cover both recognition and production under time limits.",
    ]),
    section("procrastination", "When Procrastination Blocks Exam Techniques", 2, [
      "Shrink the first step: five cards, one practice question, then stop or continue. Starting small bypasses avoidance better than promising a four-hour block you postpone. SmartFlashcards shows a finite due count—psychologically easier than open-ended 'study chapter five' tasks that expand forever without retrieval proof.",
    ]),
    section("minimal-stack", "A Minimal Technique Stack for Busy Weeks", 2, [
      "If time is tight, run only three moves: twenty minutes SmartFlashcards reviews, one timed practice section, five minutes logging misses into new cards. Skip new reading unless assigned. This minimal stack preserves exam preparation techniques when life collapses to survival mode.",
  ...
  faqs: [
    ...
    {
      question: "Can SmartFlashcards replace a study planner?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Short timed blocks, visible due counts, immediate feedback from flashcards, and reduced activation energy beat marathon passive study. SmartFlashcards breaks work into finite queues; pair with external timers and body-doubling when helpful. Consistency matters more than perfect environments.",
    },
    {
