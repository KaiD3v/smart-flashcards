...
export const flashcardsForExams: SeoPageContent = {
  ...
  sections: [
    section("science-of-retrieval", "Why Retrieval Beats Re-Reading Before Tests", 2, [
      ...
      "SmartFlashcards automates the schedule: cards you miss return sooner; cards you know graduate to longer intervals. That means flashcards for exams compound while you still attend class and finish problem sets.",
    ]),
    ...
    section("pairing-methods", "Pairing Flashcards With Practice Tests and Problems", 2, [
      ...
      "SmartFlashcards keeps that loop fast: paste the explanation paragraph, generate a card, review it next week while working the next practice set.",
    ]),
    ...
    section("smartflashcards-advantage", "Why SmartFlashcards for Exam Season", 2, [
    ...
    section("subject-playbooks", "Subject Playbooks for Exam Flashcards", 2, [
      ...
      "SmartFlashcards tags let you switch playbooks in one account—`chem::` versus `hist::`—without merging unrelated cards into one overwhelming queue.",
    ]),
    section("open-book", "Open-Book and Formula-Sheet Exams", 2, [
      "Open-book exams still reward fast retrieval—you cannot search efficiently if you do not know what to look for. Flashcards build the index in your head: where a topic lives in notes, which formula applies, which exception breaks the rule. SmartFlashcards keeps those pointers sharp even when the exam allows references.",
    ...
    section("languages", "Language and Vocabulary Exam Flashcards", 2, [
      "Language exams need high card volume with short fronts—meaning, gender, irregular conjugations, collocations. SmartFlashcards FSRS prevents vocabulary cram death: words you knew Tuesday return Friday if you missed them. Pair audio practice outside the app; cards hold spelling and meaning retrieval the written exam demands.",
    ]),
    section("first-exam", "Your First Exam With SmartFlashcards", 2, [
      ...
      "Flashcards for exams work when the timeline is explicit. SmartFlashcards due queue tells you exactly what today requires so willpower is not the bottleneck.",
    ]),
  ],
  faqs: [
    {
    ...
    {
      question: "Does SmartFlashcards work on mobile?",
      answer:
