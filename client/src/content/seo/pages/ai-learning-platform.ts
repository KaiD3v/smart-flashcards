...
export const aiLearningPlatform: SeoPageContent = {
  ...
  sections: [
    section("platform-definition", "What Makes a Platform Different from a Tool", 2, [
      ...
      "MyRemynd stores your subjects, decks, and FSRS parameters centrally. Return tomorrow or next month and your due cards, stability scores, and edit history remain intact. That persistence is what transforms AI from a novelty into infrastructure for semester-long learning.",
    ...
    section("core-capabilities", "Core Capabilities to Expect", 2, [
      ...
      "MyRemynd delivers each capability without requiring plugin installation or manual configuration. Upload a PDF, generate flashcards, review with four-button FSRS ratings, and monitor due counts from your dashboard. The platform handles everything between input and retention.",
    ]),
    ...
    section("audience", "Who AI Learning Platforms Serve", 2, [
      ...
      "Platforms fail when they target everyone generically. MyRemynd focuses on exam-oriented learners who need to retain large factual bases. That focus shapes every design decision from AI prompt tuning to the minimal review interface.",
    ]),
    section("vs-lms", "AI Platforms vs Traditional LMS", 2, [
      ...
      "MyRemynd sits alongside your LMS. Download the lecture PDF from Canvas, upload it to MyRemynd, and build a FSRS-powered deck. The LMS handles course administration; MyRemynd handles memory.",
    ]),
    section("implementation", "Implementing an AI Platform in Your Routine", 2, [
      ...
      "Fifteen minutes each morning on MyRemynd compounds into comprehensive coverage by exam week. The platform does not require discipline to configure algorithms or organize files. It requires only the discipline to open it daily.",
    ]),
    section("future", "The Future of AI Learning Platforms", 2, [
      ...
      "MyRemynd is positioned at that intersection: modern AI for content creation and FSRS for memory management. As a student, choosing a platform with both capabilities today means your study infrastructure improves as each component evolves.",
    ]),
    section("onboarding", "Onboarding in Under Thirty Minutes", 2, [
      ...
      "Platforms fail when onboarding takes longer than one study period. MyRemynd targets a sub-thirty-minute path from zero to first review because delayed starts mean students revert to old habits before experiencing the retention benefit.",
  ...
  faqs: [
    {
      ...
      answer:
        "An AI learning platform combines artificial intelligence for content generation with persistent storage and adaptive scheduling. MyRemynd generates flashcards and applies FSRS spaced repetition in one integrated system you use daily.",
    },
    {
      question: "How is MyRemynd different from Coursera or Khan Academy?",
      answer:
        "Course platforms deliver pre-built content. MyRemynd works with your own course materials, generating flashcards and scheduling FSRS reviews specific to your syllabus.",
    },
    {
      question: "Does the platform work on mobile devices?",
      answer:
        "MyRemynd runs in mobile browsers, letting you complete FSRS review sessions from your phone between classes or during commutes without installing a separate app.",
    },
    {
      question: "Can I organize multiple courses on the platform?",
      answer:
        "Yes. MyRemynd supports subjects and decks so you can separate courses while maintaining independent FSRS schedules for each. Your daily queue combines due cards from all subjects automatically for efficient review sessions.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "MOOCs deliver fixed curricula to many learners. Platforms like MyRemynd work with your specific course materials and personalize FSRS scheduling to your individual recall performance.",
    },
    {
