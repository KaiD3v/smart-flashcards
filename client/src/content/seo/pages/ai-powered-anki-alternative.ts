...
export const aiPoweredAnkiAlternative: SeoPageContent = {
  ...
  seoTitle: "AI-Powered Anki Alternative | MyRemynd",
  metaDescription:
    "MyRemynd is an AI-powered Anki alternative: generate flashcards from PDFs, study with FSRS spaced repetition, and practice active recall online.",
  h1: "An AI-Powered Anki Alternative for PDFs, FSRS, and Active Recall",
  intro:
    "An AI-powered Anki alternative should do more than autocomplete text—it should shrink the distance between your readings and retrieval practice. MyRemynd uses AI to draft flashcards from uploaded PDFs, then schedules reviews with FSRS spaced repetition and active recall sessions in the browser. You edit for accuracy, rate recall honestly, and let the system handle intervals while you focus on exams—not card factory labor. The following sections explain responsible AI editing, scaling decks safely, academic honesty, and why unified scheduling beats copying chat output into a separate app. Treat AI as a fast first draft today, not a substitute for verifying facts against your PDF.",
  sections: [
    section("ai-role", "What AI should do in a flashcard app", 2, [
      "Useful AI removes blank-page paralysis. It highlights definitional sentences, turns headings into prompts, and proposes answers grounded in your document—not random internet trivia. MyRemynd treats AI as a first-pass author you supervise, which keeps quality high while slashing creation time.",
      "Poor AI flashcard tools stop at generic summaries. MyRemynd pairs generation with FSRS so cards actually return on optimal days. Without spaced repetition, AI content is just another highlight reel you forget by Friday.",
    ]),
    section("pdf-pipeline", "PDF upload plus AI: the core pipeline", 2, [
      "Most AI study hype ignores format friction. Students live in PDFs. MyRemynd ingests those files directly, segments content, and outputs question-answer candidates aligned to section structure. You merge overlapping cards, fix terminology, and delete low-yield facts before studying.",
    ...
    section("human-in-loop", "Human-in-the-loop editing keeps cards exam-safe", 2, [
      "AI can misread tables, confuse similar terms, or over-generalize. MyRemynd expects you to skim every prompt like a teaching assistant grading a quiz. Thirty minutes of editing beats three hours of manual entry, but those thirty minutes are non-negotiable for high-stakes courses.",
    ...
    section("fsrs-layer", "FSRS: where AI output becomes long-term memory", 2, [
      "Drafting cards is only step one. FSRS spaced repetition models how stable each memory is, stretching easy prompts and recycling shaky ones. MyRemynd connects AI creation directly to that scheduler so new cards enter the same queue as mature facts.",
    ...
    section("active-recall-ai", "Active recall trains retrieval, not recognition", 3, [
      "MyRemynd study mode forces you to answer before revealing AI-sourced explanations. That gap is where learning happens. Rating difficulty feeds FSRS, which decides whether you see a card tomorrow or next month.",
    ...
    section("vs-chatgpt", "Why not just use ChatGPT for flashcards?", 2, [
      "General chat models generate lists, but they do not own your review calendar. You would still copy prompts into another tool, lose PDF structure, and forget FSRS entirely. MyRemynd unifies ingestion, editing, scheduling, and sessions.",
    ...
    section("get-started-ai", "Start your AI-powered deck responsibly", 2, [
      ...
      "After a week, notice which prompts you miss repeatedly—those topics need narrower questions or supplemental cards. MyRemynd makes iteration cheap, which is how AI assistance compounds instead of becoming noise.",
    ...
    section("ethics-academics", "Academic honesty with AI flashcards", 2, [
      "Your institution may have AI policies. Using MyRemynd to draft cards you verify is study support; submitting AI text as your own work is not. Keep the distinction clear.",
  ...
  faqs: [
    {
      question: "How is MyRemynd different from other AI flashcard apps?",
      answer:
