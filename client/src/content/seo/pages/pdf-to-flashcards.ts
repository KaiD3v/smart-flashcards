...
export const pdfToFlashcards: SeoPageContent = {
  ...
  sections: [
    ...
    section("what-works", "What makes a good PDF-to-flashcard workflow?", 2, [
      "Start with clean source material when you can. Native PDFs and text-based DOCX files parse more reliably than blurry scans, though many tools—including MyRemynd—still handle typical academic uploads well. Name your file by course and week so you can find the right deck months later during finals.",
      ...
      "Pair conversion with spaced repetition. Generating cards is only half the job; scheduling reviews so you see hard cards more often is what moves information into long-term memory. MyRemynd uses FSRS scheduling so your PDF-derived deck adapts to what you actually remember, not a fixed calendar.",
    ]),
    ...
    section("manual-vs-ai", "Manual card writing vs AI-assisted conversion", 2, [
      ...
      "The best results combine both: let MyRemynd draft cards from your document, then delete duplicates, merge overlapping prompts, and add instructor-specific twists ('Dr. Lee always asks about the Krebs cycle regulation step'). Treat AI output as a skilled study partner, not an infallible author. Your edits are where the deck becomes exam-ready.",
    ]),
    ...
    section("smartflashcards", "How MyRemynd handles PDF to flashcards", 2, [
      "Upload your PDF, DOCX, or TXT, choose a subject, and MyRemynd analyzes the text to propose a deck aligned with your material. You review, edit, and save—then study with FSRS-backed scheduling and a calm interface designed for daily sessions, not configuration rabbit holes.",
  ...
  faqs: [
    {
      ...
      answer:
        "Yes, for most text-based PDFs used in school and work. Scanned pages may need clearer OCR source files, but typical lecture and textbook PDFs work well. Upload to MyRemynd, review generated cards, and edit anything that needs your instructor's exact wording.",
    },
    {
      question: "Does MyRemynd support formats besides PDF?",
      answer:
