...
export const medicalSchoolFlashcards: SeoPageContent = {
  ...
  seoTitle: "Medical School Flashcards Made Faster | SmartFlashcards",
  metaDescription:
    "Create and review medical school flashcards with AI drafting and FSRS scheduling. SmartFlashcards turns notes into high-yield decks for shelves and boards.",
  h1: "Medical School Flashcards Without the Deck-Building Burnout",
  intro:
    "Medical school flashcards succeed when they are easy to create, ruthless to edit, and impossible to ignore on review day. SmartFlashcards reduces the friction of building decks from syllabi and PDFs while keeping you in control of what enters long-term study. Whether you are in M1 biochemistry or M3 on surgery, the same workflow applies: capture high-yield facts, let spaced repetition protect them, and spend your energy on integration—not typing. Treat every lecture and missed question as raw material for cards you will still own at residency interview season.",
  sections: [
    section("med-school-reality", "The Reality of Flashcard Debt in Med School", 2, [
      ...
      "SmartFlashcards treats review load as a first-class metric. You see how today's queue was calculated, which decks contribute the most burden, and where to trim. That transparency helps you maintain a sustainable pipeline through shelf season instead of nuking decks in panic before NBME week.",
    ]),
    section("ai-drafting", "AI Drafting That Respects Your Sources", 2, [
      "Generic AI summaries fail med students because exams reward local emphasis—your professor's favorite classification, your hospital's antibiotic protocol, the mnemonic your tutor repeated. SmartFlashcards generates prompts from the text you provide, so cards trace back to your material. You approve, edit, or reject each suggestion before it enters the schedule.",
    ...
    section("deck-architecture", "Deck Architecture for Four Years of Medicine", 2, [
      ...
      "Naming conventions matter when you have hundreds of subdecks. Use consistent prefixes like `CV::arrhythmia::` or `PHARM::autonomic::` so search and filter stay intuitive. SmartFlashcards tagging replaces brittle folder hierarchies with flexible filters you can combine before a study session.",
    ]),
    section("quality-control", "Quality Control: Editing Like a Editor, Not a Archivist", 2, [
      ...
      "Schedule a weekly fifteen-minute audit: sort by highest failure rate, fix ambiguous wording, merge duplicates. SmartFlashcards surfaces struggle cards naturally through review history, so your maintenance targets the highest-impact fixes instead of random deck browsing.",
    ]),
    section("rotation-strategy", "Rotation-by-Rotation Flashcard Strategy", 2, [
      ...
      "Protect at least ten minutes of reviews on busy rotations. Night float weeks may mean zero new cards but maintained mature reviews—that trade preserves months of prior work. SmartFlashcards mobile-friendly reviews make that feasible between notes and handoffs.",
    ]),
    section("why-smartflashcards", "Why Students Choose SmartFlashcards Over DIY Decks", 2, [
      "Traditional tools assume you enjoy spending Sunday nights formatting cards. SmartFlashcards assumes you prefer studying medicine. AI-assisted creation, FSRS scheduling, PDF ingestion, and a clean review interface remove toolchain friction so energy goes to recall practice.",
    ...
    section("collaboration", "Study Groups Without Losing Deck Quality", 2, [
      ...
      "Avoid unmoderated mega-decks with inconsistent phrasing; they inflate review time. SmartFlashcards per-user queues mean shared creation does not force identical schedules—each student still gets FSRS intervals tuned to individual recall.",
    ]),
    section("dedicated-prep", "Medical School Flashcards Into Dedicated and Boards", 2, [
      "Dedicated study is not the time to build thousand-card decks from scratch—it is the time to sharpen retrieval on facts exams assume you already know. Maintain a lean mature set, add cards only from missed themes, and let UWorld dominate calendar blocks. SmartFlashcards filtered tags (`step::`, `weak::`) keep flashcard minutes focused.",
  ...
  faqs: [
    {
      question: "How is SmartFlashcards different from shared Anki decks?",
      answer:
        "Shared decks vary in quality and may not match your curriculum. SmartFlashcards builds from your sources so cards align with what you are actually tested on, while still giving you spaced repetition discipline.",
    },
    {
