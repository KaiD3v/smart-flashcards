...
export const howToUseActiveRecall: SeoPageContent = {
  ...
  sections: [
    section("start-small", "Start With One Unit of Material", 2, [
      ...
      "Open your source, list ten to thirty key ideas, and phrase each as a question. If you use SmartFlashcards, paste the notes or upload the PDF and edit the generated cards until each one asks for a single fact or relationship. Quality beats quantity at the beginning.",
    ]),
    ...
    section("flashcard-workflow", "A Flashcard Workflow That Stays Active", 2, [
      ...
      "SmartFlashcards tracks those ratings with FSRS so you are not manually picking tomorrow's list. Your job is retrieval and honest feedback; the app handles timing. That division of labor is how busy students keep the method alive all semester.",
    ]),
    section("non-flashcard-options", "Active Recall Without a Deck Yet", 2, [
      ...
      "These methods pair well with SmartFlashcards. Use free recall to discover gaps, then add cards only for what you missed. You spend card-creation time on high-value gaps instead of transcribing material you already know.",
    ]),
    ...
    section("course-types", "Adapt Active Recall to Different Course Types", 2, [
      ...
      "Do not copy one deck template from the internet for a unrelated course. Spend ten minutes after the first lecture aligning prompts with how your instructor tests. SmartFlashcards makes iteration cheap: edit awkward cards the same week they fail in practice.",
    ]),
    ...
    section("smartflashcards-start", "Put the Steps Together in SmartFlashcards", 2, [
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Spend most of it on due retrieval in SmartFlashcards. If time remains, skim new material once, then add cards only for what you could not explain.",
    },
    {
