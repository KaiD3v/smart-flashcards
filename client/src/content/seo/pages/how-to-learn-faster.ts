...
export const howToLearnFaster: SeoPageContent = {
  ...
  sections: [
    section("fast-vs-shallow", "Fast Learning vs Shallow Cramming", 2, [
      ...
      "Measure speed by days to stable recall, not pages per hour. Stable recall is when you answer cards correctly after widening intervals in SmartFlashcards.",
    ]),
    section("rapid-gap-finding", "Find Gaps Early With Retrieval", 2, [
      ...
      "AI generation in SmartFlashcards accelerates card creation from notes and PDFs so gap-finding keeps pace with fast-moving courses.",
    ]),
    ...
    section("learn-by-doing", "Apply Early in Problem-Heavy Courses", 2, [
      ...
      "SmartFlashcards is not a substitute for problem practice, but it accelerates the factual layer problems assume you already know.",
    ]),
    section("reduce-setup", "Reduce Setup Friction", 2, [
      ...
      "Keep one subject workspace per course in SmartFlashcards so materials and decks stay findable without reorganizing every week.",
    ]),
    ...
    section("feedback-speed", "Use Feedback Speed to Accelerate", 2, [
      ...
      "SmartFlashcards review logs and tag filters make feedback visible across weeks. Speed comes from fixing the right gap once, not from repeating the wrong study action faster.",
    ]),
    section("language-learning", "Learn Languages Faster With Retrieval", 2, [
      ...
      "SmartFlashcards imports word lists and reading notes so you spend less time typing and more time retrieving.",
    ]),
    section("reading-strategy", "Read With Questions in Mind", 2, [
      ...
      "Questions convert passive reading into targeted input that feeds cards and problems. SmartFlashcards captures whatever you still cannot answer after the closed-book pass.",
    ]),
    section("faster-habit", "Build a Faster Learning Habit", 2, [
      ...
      "Learn faster by trusting the scheduler and protecting short daily sessions. SmartFlashcards is built for that loop, not for ornamental study aesthetics.",
    ...
    section("compare-progress", "Compare Progress on Retention, Not Hours", 2, [
      ...
      "SmartFlashcards history supports retention-focused comparison better than color-coded planners alone.",
    ]),
  ...
  faqs: [
    ...
    {
      question: "Where does SmartFlashcards save the most time?",
      answer:
