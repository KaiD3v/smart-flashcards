...
export const whatIsSpacedRepetition: SeoPageContent = {
  ...
  sections: [
    ...
    section("common-formats", "Common Formats and Tools", 2, [
      ...
      "MyRemynd goes further by generating those cards from your own materials. Paste notes, upload a PDF, or describe a topic and the platform creates a focused deck. FSRS then manages the review calendar so you spend time learning, not administrating schedules.",
    ]),
    section("misconceptions", "Common Misconceptions", 2, [
      ...
      "Others assume it requires technical setup or addon configuration. MyRemynd removes that barrier with a web-based interface, AI card generation, and FSRS built in from the first card you create. You do not need to understand the math behind the algorithm to benefit from it.",
    ]),
    section("next-steps", "From Definition to Daily Practice", 2, [
      ...
      "Track how much you remember on practice tests compared to your old study habits. Most students notice fewer all-nighters and less anxiety before exams because knowledge stays accessible week after week. That is the practical promise of spaced repetition, and MyRemynd is built to deliver it.",
    ]),
    section("classroom-context", "Spaced Repetition in Classroom Context", 2, [
      ...
      "MyRemynd makes that alignment practical by generating cards from weekly readings and scheduling FSRS reviews across the entire term. Instead of re-learning Unit One the night before the final, you maintain it with five-minute daily sessions starting when the unit was first assigned.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Software makes spacing practical at scale because it tracks thousands of intervals automatically. MyRemynd handles scheduling with FSRS and generates flashcards from your study materials so you can start immediately.",
    },
    {
    ...
    {
      question: "What rating system does MyRemynd use?",
      answer:
