...
export const pharmacologyFlashcards: SeoPageContent = {
  ...
  sections: [
    section("why-pharm-cards", "Why Flashcards Beat Re-Reading Pharm Tables", 2, [
      ...
      "Spaced repetition spreads drugs across days so you learn the class story once and revisit individual agents before forgetting. SmartFlashcards queues struggling cards more frequently, which is ideal for look-alike antibiotics and antihypertensives that differ by one letter on the stem.",
    ]),
    ...
    section("high-yield-topics", "High-Yield Pharm Topics for Med School and Shelves", 2, [
      ...
      "Do not neglect toxidromes and antidotes—they are fast points. Organophosphate poisoning, acetaminophen overdose, and opioid reversal are classic one-card wins. SmartFlashcards tagging lets you drill `tox::` or `antidote::` subsets the night before a shelf without touching unrelated decks.",
    ]),
    section("building-decks", "Turning Lecture PDFs Into Pharm Decks", 2, [
      "Paste your school's pharm deck PDF or table export into SmartFlashcards. The AI proposes mechanism and adverse-effect prompts; you verify against your syllabus because professors vary on first-line choices. Edit stems to mirror NBME phrasing when you are board-focused.",
    ...
    section("maintenance", "Maintaining Pharm Decks Without Burnout", 2, [
      ...
      "SmartFlashcards review analytics show whether your daily cap is realistic. If overdue cards snowball, reduce new additions for a week rather than stopping reviews entirely. Consistency preserves the hardest-won pharm knowledge across clerkships.",
    ]),
    section("look-alikes", "Separating Look-Alike Drugs With Comparison Cards", 2, [
      "Pharmacology exams love near-miss distractors: SSRIs with different CYP effects, beta blockers with or without ISA, insulin types by onset. Build explicit comparison fronts: 'Which sulfonylurea is preferred in renal impairment?' rather than isolated monotherapy facts. SmartFlashcards struggle metrics reveal which comparisons you still confuse after three exposures.",
    ...
    section("toxicology", "Toxicology and Antidote Cards for Fast Points", 2, [
      "Overdose presentations are high-yield per minute of study: acetaminophen timing and antidote, opioid reversal, TCA QRS widening, salicylate mixed acid-base patterns. One card per toxidrome keeps reviews fast. SmartFlashcards tags like `tox::` isolate these for pre-clinical exams and EM rotations alike.",
    ...
    section("ward-integration", "Ward Integration: Formulary Reality vs Lecture Ideal", 2, [
      ...
      "Paste hospital antibiogram summaries or pharmacy handouts into SmartFlashcards, edit AI cards to local protocols, and review them before call nights. Local cards complement national board decks without replacing them.",
    ]),
    ...
    section("start-pharm", "Your First Week With Pharmacology Flashcards", 2, [
      "Choose one drug class lecture, generate twenty edited cards, and complete reviews five days in a row before expanding. Notice which comparison cards fail twice—those become priority edits. SmartFlashcards struggle sorting makes those fixes obvious without rereading entire chapters.",
  ...
  faqs: [
    ...
    {
      question: "Can SmartFlashcards handle table-heavy PDFs?",
      answer:
