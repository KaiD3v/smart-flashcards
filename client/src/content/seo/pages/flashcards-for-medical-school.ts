...
export const flashcardsForMedicalSchool: SeoPageContent = {
  ...
  seoTitle: "Flashcards for Medical School | MyRemynd",
  metaDescription:
    "Build high-yield flashcards for medical school from lecture notes and textbooks. MyRemynd uses AI and spaced repetition for long-term retention.",
  h1: "Flashcards for Medical School That Match How You Actually Learn",
  intro:
    "Medical school rewards recall under pressure, not passive familiarity with slides. Flashcards for medical school work when they are atomic, clinically grounded, and reviewed on a schedule that fights the forgetting curve. MyRemynd helps you turn dense lecture PDFs and ward notes into focused decks, then schedules reviews with an FSRS-based engine so high-yield facts stay accessible during shelf exams and boards. The students who thrive treat flashcards as clinical infrastructure—maintained daily, edited ruthlessly, and paired with questions—not as a last-minute cramming tool they abandon after block one.",
  sections: [
    ...
    section("smartflashcards-workflow", "From Lecture Notes to Decks in MyRemynd", 2, [
      "MyRemynd is built for students who already live in PDFs and copy-pasted slides. Upload a lecture export or paste a transcript, and the AI proposes cards aligned with your source—not generic summaries that miss your professor's emphasis. You edit prompts before saving, which keeps quality high without spending hours typing every card manually.",
    ...
    section("systems-and-blocks", "Organizing Decks by System, Block, and Exam", 2, [
      ...
      "Suspend aggressively after local exams. Keeping every card active year-round inflates daily reviews and burns you out. MyRemynd lets you pause decks without losing progress, so you can reactivate renal cards before nephrology shelf while keeping embryology dormant until boards crossover topics return.",
    ]),
    ...
    section("pairing-with-clinical", "Pairing Flashcards With Questions and Clinics", 2, [
      ...
      "On wards, convert one teaching point per day into a card: a murmur association, a lab interpretation, a consent nuance. Small additions keep decks clinically fresh without overwhelming night shifts. MyRemynd syncs progress across devices so a five-minute phone session between patients still counts toward your schedule.",
    ]),
    ...
    section("volume-planning", "Planning Review Volume Across the Semester", 2, [
      ...
      "MyRemynd shows how many cards are due and why, which helps you negotiate tradeoffs with classmates who brag about thousand-card days. Consistent four-hundred-card weeks often beat sporadic two-thousand-card weekends because memory consolidation happens across sleep cycles, not in one heroic session.",
    ]),
  ],
  faqs: [
    {
    ...
    {
      question: "Can MyRemynd import my Anki decks?",
      answer:
