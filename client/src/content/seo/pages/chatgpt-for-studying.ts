...
export const chatgptForStudying: SeoPageContent = {
  ...
  metaDescription:
    "Learn how to use ChatGPT for studying effectively and when SmartFlashcards with FSRS is the better choice for flashcard retention.",
  ...
  sections: [
    ...
    section("effective-workflow", "Combining ChatGPT with SmartFlashcards", 2, [
  ...
  faqs: [
    {
      ...
      answer:
        "No. ChatGPT lacks persistent decks and spaced repetition scheduling. SmartFlashcards provides both with AI generation and FSRS, making it the better choice for long-term retention across a full semester or degree program.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Copy key facts into SmartFlashcards manually or upload your original source material for automatic AI generation with FSRS scheduling included. The upload path is faster for lecture PDFs and produces more complete decks for exam prep.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Uploading a PDF to SmartFlashcards is typically faster than prompting ChatGPT and manually formatting output. Cards enter FSRS scheduling immediately without extra steps.",
    },
    {
      question: "Can I use ChatGPT to explain SmartFlashcards cards I miss?",
      answer:
    ...
    },
    {
      ...
      answer:
        "ChatGPT helps explain concepts but cannot schedule spaced reviews across thousands of facts. Medical students typically pair chat explanations with SmartFlashcards FSRS decks built from lecture PDFs, slides, and practice question banks.",
    },
  ],
  relatedSlugs: [
    "ai-study-tools",
