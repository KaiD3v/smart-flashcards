...
export const anatomyFlashcards: SeoPageContent = {
  ...
  sections: [
    section("spatial-memory", "Why Spatial Subjects Need Active Recall", 2, [
      ...
      "Rotate perspectives in your prompts: anterior vs posterior relations, cross-sectional levels (T10 esophageal hiatus), and 'what lies medial to X at the knee.' MyRemynd text cards complement image-based study; paste lab objectives and let AI propose relation-style questions you refine for your cadaver team's emphasis.",
    ]),
    ...
    section("lab-practicals", "Preparing for Lab Practicals With Flashcards", 2, [
      ...
      "Pair cadaver time with immediate card creation: one new card per confusing station before you forget the spatial context. MyRemynd lets you paste station notes from lab manuals and generate prompts overnight, so the next morning's review reinforces what your hands explored.",
    ]),
    section("smartflashcards-anatomy", "Building Anatomy Decks in MyRemynd", 2, [
    ...
    section("long-term-retention", "Carrying Anatomy Into Clerkships and Boards", 2, [
      ...
      "MyRemynd cross-device sync keeps reviews feasible on commutes. When a surgery attending asks about a structure during a case, add one card that night. That habit turns clerkships into spaced reinforcement instead of passive observation.",
    ]),
    section("imaging-bridge", "Linking Anatomy Flashcards to Imaging and Procedures", 2, [
      ...
      "When MyRemynd AI drafts from radiology chapter PDFs, edit stems to emphasize level-based anatomy (T4-T9 esophagus) rather than vague region names. Exams reward precision; your cards should too.",
    ]),
    section("embryology-crossover", "Embryology and Anatomy Crossover Cards", 2, [
      "Many congenital presentations trace to embryology failures—fistulas, arch derivatives, gut rotation. Link embryology events to adult anatomy in two-step cards so Step questions connecting both feel familiar. MyRemynd AI from embryology PDFs needs heavy editing; keep cards short and sequential.",
    ...
    section("getting-started", "Start Your Anatomy Deck This Week", 2, [
      "Pick one region you are dissecting now, upload the lab PDF to MyRemynd, and approve fifteen edited cards before Friday. Review them daily next week and add ten more after lab. Small starts beat a deferred mega-deck you never open.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes—upload or paste lab objectives and dissector excerpts in MyRemynd, then edit AI suggestions to match your cadaver team's checklist before scheduling reviews.",
    },
    {
